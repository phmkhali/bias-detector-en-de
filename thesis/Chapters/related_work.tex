...
\subsubsection{Contextual analysis}
...
% The comprehensive study by Lardelli et al. quantifies these biases for German translations with particular clarity. Their findings show that when processing isolated words, machine translation systems use masculine forms in \textbf{93-96\%} of cases, with feminine forms limited to stereotypically female roles (2-4\%). Strikingly, gender-neutral or inclusive forms appear in just \textbf{0-2\%} of translations. Even when provided with contextual information, masculine forms remain dominant (85\%), while feminine (1\%) and truly gender-neutral forms (15\%) remain marginal. These results demonstrate that current systems not only reflect existing societal biases but frequently amplify them, creating outputs that are more gendered than their input texts or real-world distributions would warrant.
