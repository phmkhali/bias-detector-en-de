...
\textbf{NLP} focuses on developing machine algorithms capable of understanding and generating human language. The goal is to mimic and understand it as fluently as possible \citep{smacchiaDoesAIReflect2024,ullmannGenderBiasMachine2022}. Typical applications of NLP systems are chatbots, translators and speech recognition, image captioning and many more.
\textbf{MT} is a sub-field on NLP.
