...
Since there is no clear definition, this work defines gender bias based on the three manifestations described above: \textbf{Defaulting to Masculine Forms, Reinforcement of Stereotypes and Neglecting Contextual Information.} Any text that exhibits one or more of these forms will be considered gender biased.
