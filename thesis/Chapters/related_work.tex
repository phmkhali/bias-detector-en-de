...
These examples apply when the gender of the subjects is ambiguous. But when gender is known, especially in singular mentions, the generic masculine should be avoided. Instead, the correct gender form should be used to consitute as GFL. 
