...
\section{Evaluation Strategy}
    ...
    However, since the dataset was handcrafted and had known weaknesses, I did not rely on the validation set alone to judge final performance. To get a clearer picture of how well the model generalizes, I created a separate handcrafted test set. This set includes EN-DE sentence pairs with manually added bias labels.
    
    Based on those two evaluation strategies, I tuned the hyperparameters to gradually improve performance.
