...
sampled_mgente_biased = mgente_biased.sample(n=160, random_state=10)
sampled_lardelli_neutral = lardelli_neutral.sample(n=100, random_state=10)
sampled_wiki_neutral = wiki_neutral.sample(n=200, random_state=10)
sampled_mgente_neutral = mgente_neutral.sample(n=300, random_state=10)
...
final_df.to_csv("datasets/1k_samples_40_60.csv", index=False)

print("Saved 1000 entries to datasets/1k_samples_40_60.csv")
